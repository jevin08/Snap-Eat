...
const UpdateFood = () => {
  ...
  const handleSubmit = (event) => {
    ...
    setIsLoading(true);
    axios.put(`${APP_API}/v1/food/update/${id}`,
      food,
      {
        headers: {
          'Accept': 'application/json',
      ...
      .then(response => {
        ...
        console.log(food);
        let dely = 50;
        Notify({ message: `${food.name} updated successfully`, type: "success" });
        setIsLoading(true);
        setTimeout(() => {
    ...
    <>
      <div className="d-flex justify-content-around row">
        ...
        <div className="form-group">
          ...
          <input type="text" className="form-control" id="description" aria-describedby="descriptionHelp" placeholder="Enter description" autoFocus value={food.description} onChange={(e) => updateFood({ description: e.target.value })} required />
